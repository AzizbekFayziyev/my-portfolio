...
const Projects = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-[-320px] right-[-400px] md:right-[-320px] w-[640px] h-[640px] rounded-full bg-circlesColor z-0" />
      <div className="absolute bottom-[-320px] left-[-400px] md:left-[-320px] w-[640px] h-[640px] rounded-full bg-circlesColor z-0" />
    </section>
  );
};
